...
extension Spark {
    ...
    public func get(_ request: Spark.Request) -> AnyPublisher<Data, Swift.Error> {
    ...
    public func get<Model>(
        ...
        requestModifier: Spark.RequestModifier? = nil,
        model: Model.Type
    ) -> AnyPublisher<Model, Swift.Error> where Model: Codable {
        request(url: url, method: .get, encoding: encoding, parameters: parameters, headers: headers, requestModifier: requestModifier)
            .decode(type: model, decoder: JSONDecoder.sk.decoder)
            .eraseToAnyPublisher()
    }

    public func get<Model>(_ request: Spark.Request, model: Model.Type) -> AnyPublisher<Model, Swift.Error> where Model: Codable {
        self.request(request)
            .decode(type: model, decoder: JSONDecoder.sk.decoder)
            .eraseToAnyPublisher()
    }
...
extension Spark {
    ...
    public func request<Model>(url: any URLConvert, method: Spark.Method, encoding: Spark.ParameterEncoding, parameters: Spark.Parameters? = nil, headers: Spark.Headers? = nil, requestModifier: Spark.RequestModifier? = nil, model: Model.Type) -> AnyPublisher<Model, Swift.Error>
    where Model: Codable {
    ...
    public func request<Model>(_ request: Spark.Request, model: Model.Type) -> AnyPublisher<Model, Swift.Error> where Model: Codable {
...
extension Spark {
    ...
    /// Network Requests
    /// - Parameters:
    /// - Parameter request: configuration parameters
    /// - Returns: Server Request Information
    public func request(_ request: Spark.Request) -> AnyPublisher<Data, Swift.Error> {
